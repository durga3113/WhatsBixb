...
module.exports = {
  ...
  Module: Bixby,
  Function: Bixby,
  isPrivate: config.WORK_TYPE.toLowerCase() === "public",
  ...
  AddMp3Meta: async (
    songbuffer,
    coverBuffer,
    options = { title: "WhatsBixby Whatsapp bot", artist: ["Bixby"] }
  ) => {
    ...
    writer
      ...
      .setFrame("TPE1", ["WhatsBixby"])
      .setFrame("APIC", {
        type: 3,
        data: coverBuffer,
        description: "Bixby Public Bot",
      });
    writer.addTag();
  ...
  Mp3Cutter: async (buffer, start, end) => {
    return new Promise(async (resolve, reject) => {
      const MP3Cutter = require("./converter/mp3_cutter");
      let src = "mp3cut";
