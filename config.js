...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "jsl~FigLub2Kaep6JYBqM46Sz6uEy+XuZ3Lco+EO/w==",
  ...
  AUTHOR: process.env.AUTHOR || "DX-MODS",
  ...
  CAPTION: process.env.CAPTION || "Made By WhatsBixby",
